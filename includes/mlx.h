...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/03/23 18:20:32 by dcornea           #+#    #+#             */
/*   Updated: 2017/05/02 18:16:20 by dcornea          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void line_b(void *win, void *mlx, point p1, point p2);
...
void		push_point_toList(xyh_list **head, xyh_list *new);
void		transform_matrix(xyh_list *list);
xyh_list 	*to_list(xyh_list *new, point c, char **str);
xyh_list  	**read_list (int fd, int  *i, int *j);
point 		to_point (int x, int y);
int     	draw_matrix_line(enemi e, point **matrix, int *l, int *c);

//	AUS2_FUNCT
int     draw_matrix_column(enemi e, point **matrix, int *l, int *c);
/*
